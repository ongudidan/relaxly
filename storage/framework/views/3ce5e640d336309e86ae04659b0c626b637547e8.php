	...
	<table class="table table-borderless table-theme" style="width:100%;">
		<thead>
			<tr>
				...
				<th class="text-left" style="width:50%"><?php echo e(__('Name')); ?></th>
				<th class="text-left" style="width:10%"><?php echo e(__('Language')); ?></th>
				<th class="text-center" style="width:10%"><?php echo e(__('Image')); ?> </th>
				<th class="text-center" style="width:15%"><?php echo e(__('Status')); ?></th>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-left"><?php echo e($row->language_name); ?></td> 
...
</div><?php /**PATH E:\xampp81\htdocs\relaxly\relaxly-v1.0.0\resources\views/backend/partials/categories_table.blade.php ENDPATH**/ ?>