	...
	<table class="table table-borderless table-theme" style="width:100%;">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-left"><a href="<?php echo e(route('backend.booking', [$row->id, 'all-booking'])); ?>"><?php echo e($row->booking_no); ?></a></td>
				...
				<td class="text-center">
					<div class="btn-group action-group">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item" href="<?php echo e(route('backend.booking', [$row->id, 'all-booking'])); ?>"><?php echo e(__('Edit')); ?></a>
							<a class="dropdown-item" onClick="onCheckOutModalView(<?php echo e($row->payment_status_id); ?>, <?php echo e($row->booking_status_id); ?>, <?php echo e($row->id); ?>)" href="javascript:void(0);"><?php echo e(__('Check Out')); ?></a>
...
</div><?php /**PATH E:\xampp81\htdocs\relaxly\relaxly-v1.0.0\resources\views/backend/partials/all_booking_table.blade.php ENDPATH**/ ?>