...
<head>
	...
	<style type="text/css">
		:root {
			...
			--color-light: <?php echo e($gtext['light_color']); ?>;
			--color-blue: <?php echo e($gtext['blue_color']); ?>;
			--color-gray: <?php echo e($gtext['gray_color']); ?>;
			--color-gray-dark: <?php echo e($gtext['dark_gray_color']); ?>;
			--color-gray-400: <?php echo e($gtext['gray400_color']); ?>;
			--color-gray-500: <?php echo e($gtext['gray500_color']); ?>;
...
<body <?php echo $gtext['is_rtl'] == 1 ? 'class="rtl"' : ''; ?>>
	...
	<?php /**PATH E:\xampp81\htdocs\relaxly\relaxly-v1.0.0\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>